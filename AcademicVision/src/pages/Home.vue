<template>
  <div>
    ...
    <div class="q-pa-md" style="margin-top: 0;padding-top: 0" >
      ...
      >
        <q-carousel-slide height="400px" name="first" img-src="../assets/bg2.jpeg">
                ...
                <template v-slot:after>
                  ...
                  >
                    <q-tab-panel name="search">
                      <q-input outlined v-model="search_text" label="请输入检索词">
                        <template v-slot:prepend >
                          <q-select multiple clearable style="min-width: 125px"  borderless v-model="search_type" :options="search_type_options" label="检索类型" />
                        </template>
                        <template v-slot:append>
                          <q-avatar>
                            <q-btn icon="search" round size="14px" @click="search"></q-btn>
                          </q-avatar>
                        </template>
                      </q-input>
                      <br>
                      ...
                      />
                      <br>
                      <q-btn outline color="black" size="18px" label="高级检索" />
                    </q-tab-panel>

                    <q-tab-panel name="user_search">
                      <q-input outlined v-model="user_search_text" label="请输入用户名">
                        <template v-slot:append>
                          <q-avatar>
                            <q-btn icon="search" round size="14px" @click="search"></q-btn>
                          </q-avatar>
          ...
          <div class="absolute-bottom custom-caption">
            <div class="text-h2">Academic Vision</div>
            <div class="text-subtitle1">高效&nbsp&nbsp&nbsp精准&nbsp&nbsp&nbsp便捷&nbsp&nbsp&nbsp轻量</div>
          </div>
        </q-carousel-slide>
      </q-carousel>
    </div>
    ...
    <div class="row flex-center bg-blue-grey-2">
      <div class="col-3 q-mx-lg" style="height: 550px">
        <h4 style="margin: 20px"> 热 门 论 文 <span class="material-icons">trending_up</span></h4>
        <EachRanking v-for="each in hot_paper_list" :rank="each.rank" :context="each.context" :author="each.author"></EachRanking>
      </div>
      <div class="col-3 q-mx-lg" style="height: 550px">
        <h4 style="margin: 20px"> 热 门 学 者 <span class="material-icons">trending_up</span></h4>
        <EachRanking v-for="each in hot_scholar_list" :rank="each.rank" :context="each.context" :author="each.author"></EachRanking>
      </div>
      <div class="col-3 q-mx-lg" style="height: 550px">
        <h4 style="margin: 20px"> 热 门 关 键 词 <span class="material-icons">trending_up</span></h4>
        <EachRanking v-for="each in hot_keyword_list" :rank="each.rank" :context="each.context" :author="each.author"></EachRanking>
      </div>
    </div>
  </div>
</template>
