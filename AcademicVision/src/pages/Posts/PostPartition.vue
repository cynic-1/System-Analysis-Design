<template>
  <div>
    ...
    <div class="row" v-show="isClick === false">
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            ...
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="red-6" icon="draw" size="50px" @click="method1"/>
              <h5 style="text-align:center;margin: 0 0 10px;">文学</h5>
            </q-card-actions>
          </q-card-section>
        </q-card>
      </div>
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            ...
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="blue-6" icon="functions" size="50px" @click="method2"/>
              <h5 style="text-align:center;margin: 0 0 10px;">数学</h5>
            </q-card-actions>
          </q-card-section>
        </q-card>
      </div>
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            ...
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="pink-6" icon="spellcheck" size="50px" @click="method3"/>
              <h5 style="text-align:center;margin: 0 0 10px;">语言</h5>
            </q-card-actions>
          </q-card-section>
        </q-card>
      </div>
    ...
    <div class="row" v-show="isClick === false" style="margin-top: 20px">
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="light-blue-6" icon="devices" size="50px" @click="method4"/>
              <h5 style="text-align:center;margin: 0 0 10px;">计算机</h5>
            </q-card-actions>
            <q-img
              class="col"
      ...
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="purple-6" icon="ssid_chart" size="50px" @click="method5"/>
              <h5 style="text-align:center;margin: 0 0 10px;">物理</h5>
            </q-card-actions>
            <q-img
              class="col"
      ...
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="cyan-6" icon="science" size="50px" @click="method6"/>
              <h5 style="text-align:center;margin: 0 0 10px;">化学</h5>
            </q-card-actions>
            <q-img
              class="col"
      ...
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            ...
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="deep-purple-6" icon="biotech" size="50px" @click="method7"/>
              <h5 style="text-align:center;margin: 0 0 10px;">生物</h5>
            </q-card-actions>
          </q-card-section>
        </q-card>
      </div>
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            ...
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="teal-6" icon="precision_manufacturing" size="50px" @click="method8"/>
              <h5 style="text-align:center;margin: 0 0 10px;">自动化</h5>
            </q-card-actions>
          </q-card-section>
        </q-card>
      </div>
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            ...
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="indigo-6" icon="design_services" size="50px" @click="method9"/>
              <h5 style="text-align:center;margin: 0 0 10px;">工程建造</h5>
            </q-card-actions>
          </q-card-section>
        </q-card>
      </div>
    ...
    <div class="row" v-show="isClick === false" style="margin-top: 20px">
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="green-6" icon="attach_money" size="50px" @click="method10"/>
              <h5 style="text-align:center;margin: 0 0 10px;">金融</h5>
            </q-card-actions>
            <q-img
              class="col"
      ...
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="orange-6" icon="flight" size="50px" @click="method11"/>
              <h5 style="text-align:center;margin: 0 0 10px;">航空航天</h5>
            </q-card-actions>
            <q-img
              class="col"
      ...
      <div class="col-4">
        <q-card class="my-card" flat bordered style="margin-left: 10px">
          <q-card-section horizontal>
            <q-card-actions vertical class="justify-around q-px-md">
              <q-btn flat round color="brown-6" icon="question_answer" size="50px" @click="method12"/>
              <h5 style="text-align:center;margin: 0 0 10px;">交流</h5>
            </q-card-actions>
            <q-img
              class="col"
    ...
    <div v-show="isClick">
      <PostPartionView :name="name" @childevent="childevent"></PostPartionView>
    </div>
