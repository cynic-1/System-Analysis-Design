<template>
  <div>
    ...
    <div class="q-pa-md">
      <div class="q-gutter-md" style="max-width: 1000px;margin: 0 auto;" v-for="test in list">
        ...
        <q-field filled stack-label>
          <h3 style="margin: 10px;float: left;color: skyblue">{{ test.rank }}</h3>
          <template v-slot:control>
            <a href="https://y.qq.com/n/ryqq/songDetail/0039MnYb0qxYhV" style="text-decoration: none;color: #1D1D1D">
              <div class="self-center full-width no-outline" tabindex="0" style="font-size: 20px">
                {{ test.context }}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{{ test.author }}
              </div>
            </a>
          </template>
        </q-field>
