<template>
  <div style="width: 100%;height: 100%">
    <q-card style="width: 90%;margin: 20px auto auto auto;padding: 15px 10% 20px 10%">
      <div style="font-size: small;color: #7f7f7f">
        {{ instruction }}
      </div>
      ...
      <div style="margin-top: 20px;text-align: center">
        <span
          v-for="x in author"
          :key="x"
          style="margin-left: 30px;color: #006cd6;cursor: pointer;"
        >{{ x }}</span>
      </div>
      <div style="margin-top: 10px;text-align: center;color: #006cd6;cursor: pointer;">
        {{ school }}
      </div>
      ...
      >
        ...
        <span style="width: 94%">
          <span
            v-for="x in keywords"
            :key="x"
            style="margin-left: 10px;color: #666666;cursor: pointer;"
          >{{ x }};</span>
        </span>
      </div>
      ...
      <div
        ...
        style="margin-top: 10px"
      >
        <span style="font-weight: bold;width: 6%">专辑：</span>
        <span style="width: 94%">
      ...
      <div
        ...
        style="margin-top: 10px"
      >
        <span style="font-weight: bold;width: 6%">专题：</span>
        <span style="width: 94%">
      ...
      >
        <span style="font-weight: bold;width: 6%">分类号：</span>
        <span style="width: 94%">
